    ...
    NavigationSectionDef(
        ...
        children=(
            ...
            _child('scheduling.time_off', 'Time-Off Requests', 40, 'nav.scheduling.time_off',
                   route_path='/v2/scheduling/time-off', active_prefix='/v2/scheduling/time-off',
                   feature_key='staff_scheduling_v2',
                   show_placeholder_when_feature_disabled=True),
            ...
            _child('scheduling.rules', 'Scheduling Rules', 60, 'nav.scheduling.rules',
                   ...
                   feature_key='staff_scheduling_v2'),
            _child('scheduling.store_defaults', 'Store Defaults', 65, 'nav.scheduling.rules',
                   route_path='/v2/scheduling/store-defaults', active_prefix='/v2/scheduling/store-defaults',
                   feature_key='staff_scheduling_v2'),
            _child('scheduling.store_shifts', 'Store Shifts', 66, 'scheduling.store_shifts.manage',
                   route_path='/v2/scheduling/store-shifts/manage',
                   active_prefix='/v2/scheduling/store-shifts/manage',
                   feature_key='staff_scheduling_v2'),
            _child('scheduling.readiness', 'Readiness & Generation', 67,
                   'scheduling.manage_automation', route_path='/v2/scheduling/automation',
                   active_prefix='/v2/scheduling/automation', feature_key='staff_scheduling_v2'),
            _child('scheduling.attendance_points', 'Attendance Point Policy', 68,
                   'nav.scheduling.rules',
                   route_path='/v2/scheduling/store-defaults#attendance-point-policy',
                   active_prefix='/v2/scheduling/store-defaults',
                   feature_key='staff_scheduling_v2'),
