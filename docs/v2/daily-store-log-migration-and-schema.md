...
The Daily Store Log revision remains a required ancestor. Runtime startup accepts only current repository head `20260725_0007` and does not create or alter schema.
