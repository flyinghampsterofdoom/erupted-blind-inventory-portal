...
The Daily Store Log revision remains a required ancestor. Runtime startup accepts only current repository head `20260720_0006` and does not create or alter schema.
