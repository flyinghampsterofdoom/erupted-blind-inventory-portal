...
Use this checklist for every production release containing V2 code or schema. Copy it into the release record and attach evidence; do not mark an item complete based only on repository state. The current schema head is `20260720_0006`.
...
- [ ] Alembic chain is linear from `20260715_0001` through `20260720_0006`
- [ ] A fresh disposable PostgreSQL database upgrades successfully to `head`
- [ ] `alembic_version.version_num` equals `20260720_0006`
...
- [ ] Confirm migration completed once and target revision is `20260720_0006`
