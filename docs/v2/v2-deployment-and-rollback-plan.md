...
Status date: 2026-07-25. Current repository schema head is `20260725_0009`. This document defines deployment invariants; use the evidence-bearing [production release checklist](./v2-production-release-checklist.md) for each release and the [canary deployment guide](./v2-canary-deployment-guide.md) for staged exposure.
...
3. Validate or migrate the target to exactly the reviewed release revision (`20260725_0009` for the current inventory checkpoint) using the approved schema command.
