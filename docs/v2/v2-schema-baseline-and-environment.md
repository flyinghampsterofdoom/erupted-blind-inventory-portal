...
The V1 baseline remains `20260715_0001`. The current and only supported repository head is `20260828_0028`.
...
| `20260828_0027` | Additive post-schedule attendance and coverage event ledger |
| `20260828_0028` | Additive auditable attendance point-entry ledger |
...
4. Confirm `alembic_version.version_num = 20260828_0028`.
