...
The V1 baseline remains `20260715_0001`. The current and only supported repository head is `20260828_0027`.
...
4. Confirm `alembic_version.version_num = 20260828_0027`.
