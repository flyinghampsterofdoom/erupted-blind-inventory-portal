...
The V1 baseline remains `20260715_0001`. The current and only supported release head is `20260824_0021`.
...
4. Confirm `alembic_version.version_num = 20260824_0021`.
