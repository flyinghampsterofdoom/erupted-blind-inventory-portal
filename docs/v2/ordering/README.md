...
Status date: 2026-07-25. Status: Phase 1 read-only Ordering Intelligence is implemented in the repository but not deployed or production-exposed. V1 remains canonical for every operational Ordering workflow.
