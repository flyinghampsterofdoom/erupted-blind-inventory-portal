...
Revision `20260720_0005` adds the Digital Signage schema and is a required ancestor of current repository head `20260725_0009`. Management and persistence tests exist. The current PostgreSQL 16 verification passed; the optional real-R2 case remained skipped because `RUN_REAL_R2_TESTS` and isolated credentials were not configured. See [V2 test verification](./v2-test-verification.md).
